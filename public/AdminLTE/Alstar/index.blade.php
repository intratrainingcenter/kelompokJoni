...
<head>
  ...
  <link href="{{assets('https://fonts.googleapis.com/css?family=Montserrat:400,700|Open+Sans:400,300,700,800')}}" rel="stylesheet" media="screen">
...
<body>
  ...
  <nav class="navbar navbar-default" role="navigation">
    <div class="container">
      <div class="navbar-header">
        ...
        <a class="navbar-brand" href="{{asset('index.html')}}">SMK INTRA 1 KEDOYA</a>
  ...
  <script src="{{assets('AdminLTE/Alstar/js/jquery.js')}}"></script>
  <script src="{{assets('AdminLTE/Alstar/js/bootstrap.min.js')}}"></script>
  <script src="{{assets('AdminLTE/Alstar/js/swow.min.js')}}"></script>
  <script src="{{assets('AdminLTE/Alstar/js/mb.bgndGallery.js')}}"></script>
  <script src="{{assets('AdminLTE/Alstar/js/mb.bgndGallery.effects.js')}}"></script>
  <script src="{{assets('AdminLTE/Alstar/js/jquery.simple-text-rotator.min.js')}}"></script>
  <script src="{{assets('AdminLTE/Alstar/js/jquery.scrollTo.min.js')}}"></script>
  <script src="{{assets('AdminLTE/Alstar/js/jquery.nav.js')}}"></script>
  <script src="{{assets('AdminLTE/Alstar/js/modernizr.custom.js')}}"></script>
  <script src="{{assets('AdminLTE/Alstar/js/grid.js')}}"></script>
  <script src="{{assets('AdminLTE/Alstar/js/stellar.js')}}"></script>
  <script src="{{asset('AdminLTE/Alstar/contactform/contactform.js')}}"></script>

  
  <script src="{{assets('AdminLTE/Alstar/js/custom.js')}}"></script>
