...
<head>
  ...
  <!-- Date Picker -->
  <link rel="stylesheet" href="{{asset('AdminLTE-master/bower_components/bootstrap-datepicker/dist/css/bootstrap-datepicker.min.css')}}">
  <!-- Daterange picker -->
  <link rel="stylesheet" href="{{asset('AdminLTE-master/bower_components/bootstrap-daterangepicker/daterangepicker.css')}}">
  <!-- bootstrap wysihtml5 - text editor -->
  <link rel="stylesheet" href="{{asset('AdminLTE-master/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.min.css')}}">
...
<!-- jQuery UI 1.11.4 -->
<script src="{{asset('AdminLTE-master/bower_components/jquery-ui/jquery-ui.min.js')}}"></script>
...
<!-- Morris.js charts -->
<script src="{{asset('AdminLTE-master/bower_components/raphael/raphael.min.js')}}"></script>
<script src="{{asset('AdminLTE-master/bower_components/morris.js/morris.min.js')}}"></script>
<!-- Sparkline -->
...
<!-- jQuery Knob Chart -->
<script src="{{asset('AdminLTE-master/bower_components/jquery-knob/dist/jquery.knob.min.js')}}"></script>
<!-- daterangepicker -->
<script src="{{asset('AdminLTE-master/bower_components/moment/min/moment.min.js')}}"></script>
<script src="{{asset('AdminLTE-master/bower_components/bootstrap-daterangepicker/daterangepicker.js')}}"></script>
<!-- datepicker -->
<script src="{{asset('AdminLTE-master/bower_components/bootstrap-datepicker/dist/js/bootstrap-datepicker.min.js')}}"></script>
<!-- Bootstrap WYSIHTML5 -->
<script src="{{asset('AdminLTE-master/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.all.min.js')}}"></script>
<!-- Slimscroll -->
